          ...
          <div className="hero-text">
            ...
            <div className="cta-buttons">
              ...
              <button 
                ...
                onClick={() => window.open('mailto:Boillot.Cody@gmail.com', '_blank')}
        ...
        <div className="footer-container">
          <div className="footer-single-line">
            <div className="footer-info">
              ...
              <span className="footer-separator">•</span>
              <a href="tel:+13178697789" className="footer-phone">(317) 869-7789</a>
              <span className="footer-separator">•</span>
              <span className="footer-availability">Available for Leadership Opportunities</span>
            </div>
